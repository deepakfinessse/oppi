...
export default function JuryDashboard() {
  ...
  const pendingApps = apps.filter(a => !a.is_approved && a.status?.toUpperCase() !== 'JURY_REJECTED');
  const approvedApps = apps.filter(a => a.is_approved);
  const rejectedApps = apps.filter(a => a.status?.toUpperCase() === 'JURY_REJECTED');
      ...
      >
        <div className="dashboard-content">
          ...
          <div className="dashboard-section">
            <h3>Applications Pending Final Approval ({pendingApps.length})</h3>
                    ...
                    <tr key={a.id}>
                      ...
                      <td>
                        <div className="action-buttons">
                          ...
                          <button className="btn-action reject" onClick={() => handleRejectClick(a.id)}>Reject</button>
                        </div>
                      </td>
                    </tr>
                  ))}
                  {pendingApps.length === 0 && <tr><td colSpan="4" className="text-center">No pending applications.</td></tr>}
                </tbody>
              </table>
            </div>
          </div>
              ...
              <div className="table-responsive">
                <table className="dashboard-table">
                  ...
                  <tbody>
                    ...
                    {approvedApps.length === 0 && <tr><td colSpan="4" className="text-center">No approved applications.</td></tr>}
                  </tbody>
                </table>
              </div>
            ) : (
              <div className="table-responsive">
                <table className="dashboard-table">
                  ...
                  <tbody>
                    ...
                    {rejectedApps.length === 0 && <tr><td colSpan="5" className="text-center">No rejected applications.</td></tr>}
                  </tbody>
                </table>
              </div>
            )}
